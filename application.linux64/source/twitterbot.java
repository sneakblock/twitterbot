...
*/
public void draw() {
    frameRate(map(getWindSpeed(), 0.0f, 100.0f, 18.0f, 45.0f));
...
public void textPlace() {
    ...
    text("Temp: " + (int)((myTextPlopper.getTwo() - 273.15f) * 9/5 + 32) + "F", 10, 45);
...
public void placeRain() {
    int c = color(173, 216, 230);
...
class Pollen {
    ...
    Pollen(float positionX, float positionY, int c) {
    ...
    public void updateRainPosition() {
        wobble += .009f;
        waveinessX = .002f;
        waveinessY = .002f;
...
class textPlopper {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "twitterbot" };
    if (passedArgs != null) {
